    ...
    async def generate(self, model_name: str, prompt: str,
        ...
        if not self.api_key:
            return GenerateResult(
                content="ERROR: No Together API key configured",
                model=model_name, provider="together", error="no_api_key",
            )
        ...
        try:
            ...
            return GenerateResult(
                content=content, model=model_name, provider="together",
            ...
            return GenerateResult(
                content=f"ERROR: Together returned {code}",
                model=model_name, provider="together", error=error_type,
            )
        except Exception as e:
            return GenerateResult(
                content=f"ERROR: {str(e)}",
                model=model_name, provider="together", error="unknown",
            )
