    ...
    async def generate(self, model_name: str, prompt: str,
        ...
        if not self.api_key:
            return GenerateResult(
                content="ERROR: No Cerebras API key configured",
                model=model_name, provider="cerebras", error="no_api_key",
            )
        ...
        try:
            ...
            return GenerateResult(
                content=content, model=model_name, provider="cerebras",
            ...
            return GenerateResult(
                content=f"ERROR: Cerebras returned {code}",
                model=model_name, provider="cerebras", error=error_type,
            )
        except Exception as e:
            return GenerateResult(
                content=f"ERROR: {str(e)}",
                model=model_name, provider="cerebras", error="unknown",
            )
