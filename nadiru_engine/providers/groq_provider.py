    ...
    async def generate(self, model_name: str, prompt: str,
        ...
        if not self.api_key:
            return GenerateResult(
                ...
                model=model_name, provider="groq", error="no_api_key",
            )
        ...
        try:
            ...
            return GenerateResult(
                content=content, model=model_name, provider="groq",
            ...
            return GenerateResult(
                content=f"ERROR: Groq returned {code}",
                model=model_name, provider="groq", error=error_type,
            )
